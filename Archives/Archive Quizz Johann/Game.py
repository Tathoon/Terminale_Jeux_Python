...
class game:
    ...
    ### attributs:
        ...
        - is_active : Booléen
        - all_player : regroupe tous les joueurs
        - all_projectiles : regroupe tous les projectiles
        - all_monster : regroupe tous les monstres

    ### méthodes:
        - update -> met à jour la position du joueur
        - tirer -> le joueur lance un projectile (instance ajoutée dans all_projectile)
        ...
        - spawn_monster -> fait apparaitre une instance de la classe monster dans la liste de tous les monstres sur l'écran de jeu
        - check_collision -> renvoie un booléen si le monstre entre en collision avec un élément ou non
        - monster_vers_joueurs -> gère le déplacement des monstres seulement si celui-ci n'est pas en collision avec un joueur, sinon ils font des dégats au joueur
        - update_health_bar -> affiche la barre de vie des joueurs actualisée à chaque dégat pris
        - damage -> gère les dégats pris par les monstres
    """
