...
class guerrier(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.damage = 10
        self.speed = 7
        self.image = pygame.transform.scale(pygame.image.load("Jeu complet version finale/assets/pnj/guerrier.png"),(260,260))
...
class mage(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.damage = 35
        self.speed = 5
        self.image = pygame.transform.scale(pygame.image.load("Jeu complet version finale/assets/pnj/mage.png"),(260,260))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0