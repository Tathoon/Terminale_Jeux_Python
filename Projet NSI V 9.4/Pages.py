...
class menu_quetes:
    ...
    def __init__(self, mainScreen):
        ...
        self.descri_Quete1 = descriptions('assets/descriptions quetes/Descri_Quete1.png', 600, 320, mainScreen.get_width()/2, 250)
        self.descri_Quete2 = descriptions('assets/descriptions quetes/Descri_Quete2.png', 600, 320, mainScreen.get_width()/2, 250)
        self.descri_Quete3 = descriptions('assets/descriptions quetes/Descri_Quete3.png', 600, 320, mainScreen.get_width()/2, 250)
        self.lancer = button('assets/button/lancer.png', 400, 100, mainScreen.get_width()/2, 470)
        self.descri_Quete = 1

    def update_partie1(self, mainScreen):
        mainScreen.blit(self.background, (0,0))
    ...
    def update_quete1(self, mainScreen):
        mainScreen.blit(self.background, (0,0))
        mainScreen.blit(self.buttonRetour.image, self.buttonRetour.rect)
        mainScreen.blit(self.descri_Quete1.image, self.descri_Quete1.rect)
        mainScreen.blit(self.lancer.image, self.lancer.rect)

    def update_quete2(self, mainScreen):
        mainScreen.blit(self.background, (0,0))
        mainScreen.blit(self.buttonRetour.image, self.buttonRetour.rect)
        mainScreen.blit(self.descri_Quete2.image, self.descri_Quete2.rect)
        mainScreen.blit(self.lancer.image, self.lancer.rect)

    def update_quete3(self, mainScreen):
        mainScreen.blit(self.background, (0,0))
        mainScreen.blit(self.buttonRetour.image, self.buttonRetour.rect)
        mainScreen.blit(self.descri_Quete3.image, self.descri_Quete2.rect)
        mainScreen.blit(self.lancer.image, self.lancer.rect)
...
class quete3:
    ...
    def __init__(self, mainScreen):
        self.is_active = False
        self.background = pygame.transform.scale(pygame.image.load('assets/background/quete3_Back.png'),(mainScreen.get_size()))
