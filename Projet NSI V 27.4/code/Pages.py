...
class quete1:
    ...
    def update(self, mainScreen, pnj, evenement, defaite):
        mainScreen.blit(self.background, (0,0))
        mainScreen.blit(self.buttonRetour.image, self.buttonRetour.rect)
        pnj.update(mainScreen)
...
class defaite:
    ...
    def __init__(self, mainScreen):
        self.is_active = False
        self.retour_menu_quete = button('assets/button/button_quete2.png', 250, 125, mainScreen.get_width()/2, 500) # Bouton à changer
