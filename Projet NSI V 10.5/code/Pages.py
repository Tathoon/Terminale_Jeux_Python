...
class menu_accueil:
    ...
    def __init__(self, mainScreen):
        ...
        self.buttonStart = button("assets/button/startbutton.png", 150, 150, mainScreen.get_width()/2, mainScreen.get_height()*3/4)
...
class menu_quetes:
    ...
    def __init__(self, mainScreen):
        ...
        self.button_Quete1 = button('assets/button/button_quete1.png', 250, 125, mainScreen.get_width()/2, 300)
        self.button_Quete2 = button('assets/button/button_quete2.png', 250, 125, mainScreen.get_width()/2, 450)
        self.button_Quete3 = button('assets/button/button_quete3.png', 250, 125, mainScreen.get_width()/2, 600)
